...
invariant(storageSource.includes('session.v3'), 'Offline persistence không ở schema v3.')
...
console.log('PASS schema v1/v2→v3 + discovery/Journal durability contracts')
